...
var BuiltinAgentBookmarks = []AgentBookmark{
	{Name: "repository_operator", Purpose: "Orient in an unfamiliar repository, inspect files, make precise edits, and navigate project structure.", Tools: []string{"list_files", "search_code", "read_files", "inspect_file", "create_directory", "apply_code_edits"}, Activation: "Use for repository questions, debugging, scaffolding, and code changes."},
